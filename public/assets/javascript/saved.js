...
$(document).ready(function() {
    ...
    // Adding event listeners for dynamically generated buttons for deleting the articles,
    ...
    function renderEmpty() {
        ...
        var emptyAlert = $(
            [
                ...
                "<h4>Sorry, it looks like we don't have any saved articles.</h4>",
                "</div>",
                "<div class='panel panel-default'>",
    ...
    function handleArticleDelete() {
        ...
        $.ajax({
            ...
            // If successful, run initPage again which will rerender our list of saved articles
            if (data.ok) {
                initPage();
            }
        });
    ...
    function handleArticleNotes() {
        ...
        $.get("/api/notes/" + currentArticle._id).then(function(data) {
            ...
            // Adding information about the article and article notes to the save button for easy access
    ...
    function handleNoteSave() {
        ...
        // Sets a variable to hold some formatted data about our note,
        // grabbing the note typed into the input box
        var noteData;
        var newNote = $(".bootbox-body textarea").val().trim();
        // If data is typed into the note input field, format it
    ...
    function handleNoteDelete() {
        ...
        // First grabbing the id of the note we will delete
        // This data is stored on the delete button when we created it
